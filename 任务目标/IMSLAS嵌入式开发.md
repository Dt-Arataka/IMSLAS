...
### 要求4
1.	老师，最后要联合调试的话要确定一些参数，1-ADC采集的电压是跨阻放大器转换离子电流之后的输出电压，这个电压范围是多大（我设置的电压范围是0-5.12V）？2-我在网上查了离子峰一般出现在20ms以内（根据漂移管长度 $L$、漂移区电压 $V$、物质的迁移率 $K$来计算），我设置的横轴长度是24ms，这样合理吗？3-生成的驱动高压方波发生器的信号的占空比和频率为多少合适（我设置的是频率40Hz，占空比0.8%）
...
-  [嵌入式IMS实现同步功能改进以及物质学习UI功能实现](https://gemini.google.com/share/1fb384cb62b1)
## 1. 离子迁移谱分析仪系统
